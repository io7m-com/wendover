...
public final class WNTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(WNTestDirectories.class);

  private WNTestDirectories()
  {
    ...
    throws IOException
  {
    ...
    final var path = Path.of(property).resolve("wendover");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/wendover/tests/%s", name);
